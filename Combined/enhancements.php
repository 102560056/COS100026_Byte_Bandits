<<<<<<< HEAD:Combined/enhancements.php
<!DOCTYPE html>
<html lang="en">
        ...
        <section class="static-menu">
            <ul>
                ...
                <li class="original-menu main-color">
                    <a href="enhancements.html" class="main-color">Enhancements</a>
                </li>

                <li>
                    <label class="hamburger-menu" id="enhancement-sam">
                        <input type="checkbox">
...
>>>>>>> 02b8691345a62383bebec40dc16f2b43f7b0ef7e:Combined/enhancements.html
