...
<body class="about-body">
          ...
          <ul>
	        ...
	        <li>
                ...
                <li class="original-menu main-color">
                    <a href="about.html" class="main-color">About</a>
                </li>
    ...
    <!-- Introductin of group information -->
        ...
        <section>
            ...
            <section class="about-timetable">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <th class="column-header">1. Designing a concept graph for index page to decide the
                                desirable
                                website style</th>
                            <td class="one color"></td>
                            <td class="one color"></td>
                        ...
                        <tr>
                            <th class="column-header">2. Finishing group agreement</th>
                            <td></td>
                            <td class="two color"></td>
                            <td></td>
                            <td></td>
                        ...
                        <tr>
                            <th class="column-header">3. Assigning works</th>
                            <td></td>
                            <td class="two color"></td>
                            <td></td>
                            <td></td>
                        ...
                        <tr>
                            <th class="column-header">4. All HTML pages done</th>
                            <td></td>
                            <td></td>
                            <td class="three color"></td>
                            <td class="three color"></td>
                        ...
                        <tr>
                            <th class="column-header">5. Start at working on CSS and enhancement</th>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td class="four color"></td>
                        ...
                        <tr>
                            <th class="column-header">6. Colate all pages and tidy up</th>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
...
>>>>>>> 02b8691345a62383bebec40dc16f2b43f7b0ef7e:Combined/about.html
